	 ...
	 <button class="btn btn-primary all">Kepengurusan</button>
      <table class="striped" style="width: 800px;">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="{{url('kaumibu/edit/kepengurusan/'.$key->id)}}"><i class="material-icons prefix" style="color: #1976d2;">edit</i></a></td>
          </tr>
           @endforeach
        </tbody>
      </table>
      ...
      <button class="btn btn-primary all">Event / Acara</button> 
       <div class="input-field col s3" style="margin-top: -36px; margin-left: 700px;">
        <a href="{{url('kaumibu/add/event')}}" class="btn btn-primary all">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{substr(strip_tags($key->isi),0,15)}}...</td>
             <td><a href="{{url('kaumibu/edit/event/'.$key->id)}}"><i class="material-icons prefix" style="color: #1976d2;">edit</i></a> 
             <td><a href="{{url('kaumibu/delete/event/'.$key->id)}}"
      ...
      <br>
       ...
       <div class="input-field col s3" style="margin-top: -36px; margin-left: 700px;">
        <a href="{{url('kaumibu/add/foto')}}" class="btn btn-primary all">
        <i class="material-icons">add</i></a></button>
      </div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><img style="width: 20px;height: 20px;" src="{{url('images/'.$key->sampul)}}"></td>
              <td><a href="{{url('kaumibu/edit/foto/'.$key->id)}}"><i class="material-icons prefix" style="color: #1976d2;">edit</i></a> 
             <td><a href="{{url('kaumibu/delete/foto/'.$key->id)}}"
						onclick="return confirm('Are you sure to delete {{$key->judul}}?')"><i class="material-icons prefix" style="color: #1976d2;">delete</i></a>
          </tr>
             @endforeach
        </tbody>
